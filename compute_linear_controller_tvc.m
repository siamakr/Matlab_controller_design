...
syms Ft Fx Fy dp dr wtm wtrw tx ty tz 
...
fb = [ty/ltvc; -tx/ltvc; Ft];     %rotate the thrust-vector Ft into body frame 
...
Q = [ 10    0       0        0      0      0      0        0      ;  % Roll
      0        10   0        0      0      0      0        0      ;  % Pitch
      0        0        .1    0      0      0      0        0       ;  % Yaw
      0        0        0        1  0      0      0        0       ;  % omega_x
      0        0        0        0      1  0      0        0       ;  % omega_y
      0        0        0        0      0      .01  0        0       ;  % omega_z
      0        0        0        0      0      0      1    0     ;  % z
      0        0        0        0      0      0      0        1  ];  % v_z
...
% Step Response 
 ...
 opt.StepAmplitude = 1;                                 %set step amplitude 
 step(sys_clfb_att,  opt, 5)     %run all 3 clfbs on same graph

 figure(3)
 X0 = [1; 1; 0; 0; 0; 0];
 initial(cl_sys_att, X0, 20)